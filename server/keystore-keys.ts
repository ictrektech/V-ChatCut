// Key names accepted by the settings API and the subset safe to expose to the browser.
...
export const KEY_NAMES = [
  ...
  "V_ROUTER_TTS_MODEL",
  "V_ROUTER_TTS_VOICE_ID",
  "V_ROUTER_TRANSCRIPTION_MODEL",
  "V_ROUTER_IMAGE_MODEL",
  "V_ROUTER_VIDEO_MODEL",
