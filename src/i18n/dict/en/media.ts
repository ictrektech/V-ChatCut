...
export default {
  ...
  '搜索': 'Search',
  '上传素材': 'Upload media',
  '从 VOS / WebDAV / AI 相册导入…': 'Import from VOS / WebDAV / AI Album…',
  '选择素材预览': 'Selected media preview',
  '点选左侧素材后可在导入前查看内容。': 'Select media on the left to preview it before importing.',
  '该素材暂不支持预览': 'Preview is not available for this media',
  '从外部来源导入素材': 'Import media from external sources',
  '导入媒体': 'Import media',
  '从 VOS 存储、WebDAV 或 AI 相册选择素材': 'Select media from VOS storage, WebDAV, or AI Album',
  '打开设置': 'Open settings',
  '搜索 AI 相册': 'Search AI Album',
  '{source} 尚未配置': '{source} is not configured',
  '正在读取媒体来源…': 'Loading media sources…',
  '这里没有可导入的媒体': 'There is no media to import here',
  '已选择 {n} 个素材': '{n} media items selected',
  '正在导入…': 'Importing…',
  '导入': 'Import',
